...
```admonish info
This guide is partially adopted from [ https://wiki.archlinux.org/title/Hyper-V ](https://wiki.archlinux.org/title/Hyper-V)
```

## Required Windows Features
Search `"features"` in the start menu and open 
`Turn Windows features on or off`. Enable the following features:
- Hyper-V
